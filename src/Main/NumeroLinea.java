...
public class NumeroLinea extends JPanel
    ...
    private Color color1 = new Color(61,172,147);
    ...
    public NumeroLinea(JTextComponent component, int minimumDisplayDigits) {
        ...
        this.component.setBackground(new Color(147, 156, 147));
        ((JTextArea)this.component).setForeground(new Color(255, 255, 255));
        setFont(component.getFont());
        ((JTextArea)this.component).setFont(new Font("Consolas", 14, 14));
